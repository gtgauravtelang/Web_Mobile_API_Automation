...
@CucumberOptions(features = "src/test/resources/features/Mobiletesting",
        glue = "org.example.stepDefMobile",
        plugin = {"pretty","html:resources/cucumber-reports/cucu-report.html",
        "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"},
        monochrome = true,
        publish = true)
public class testRunnerCucMobile extends AbstractTestNGCucumberTests{
